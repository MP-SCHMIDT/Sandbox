...
void HexBoardGameAI::ComputeGameTreeSearch() {
  ...
  RootBoard= CreateBoard(Pawns, {-1, -1}, 0);
...
void HexBoardGameAI::SortSubBoards(BoardState *ioBoard, const int iDepth, const int iMode) {
...
int HexBoardGameAI::GetIdxBestSubBoard(BoardState *ioBoard, const int iDepth, const int iMode) {
...
int HexBoardGameAI::CompareBoardPair(const BoardState *iBoardA, const BoardState *iBoardB, const int iDepth, const int iMode) {
